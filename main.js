...
if('caches' in window) {
  caches.match(url)
    ...
    .then(data => { // gets the extracted json data
...
// 1) Identify the strategy we currently use in the Service Worker (for caching) -> cache, if that fails, update cache from network
